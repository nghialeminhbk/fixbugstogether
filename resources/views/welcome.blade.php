...
<header class="py-5 bg-image-full" style="background-image: url('https://source.unsplash.com/wfh8dDlNFOk/1600x900')">
    <div class="text-center my-5">
        <img class="img-fluid rounded-circle mb-4" src="{{ asset('/css/fixbugstogether-icon.png') }}" alt="..." />
        <h1 class="text-white fs-3 fw-bolder">FixBugsTogether</h1>
        <p class="text-white-50 mb-0">Community to help each other with programming</p>
    </div>
</header>
<!-- Content section-->
<section class="py-5">
